...
#
# sim01 bus-info (2026-04-02 calibrate_can_mapping.py 校准):
...
SLAVE_MAPPINGS=(
    "3-2.1.1:1.0:can_left_slave"
    "3-2.1.4:1.0:can_right_slave"
)
MASTER_MAPPINGS=(
    "3-2.1.2:1.0:can_left_mas"
    "3-2.1.3:1.0:can_right_mas"
)
