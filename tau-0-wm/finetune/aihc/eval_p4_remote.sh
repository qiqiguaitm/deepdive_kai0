...
# chunk=9 / vae_latent_c33 to match the P3 model. Launched via ssh from the driver.
set -u
REPO=/mnt/pfs/p46h4f/cosmos/deepdive_kai0/tau-0-wm
VENV=/mnt/pfs/p46h4f/cosmos/.venv
CKPT=${CKPT:-$REPO/runs/tau0_fold_p4_32g/step_10000.pt}
...
echo "[eval-p3] ckpt=$CKPT chunk=9 latdir=vae_latent_c33  $(date)"
