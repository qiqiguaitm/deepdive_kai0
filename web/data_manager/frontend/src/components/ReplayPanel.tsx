...
// Episode viewer for the data-collection web UI: video + depth playback only.
// Real-arm replay was migrated to start_autonomy.sh + start_replay_test.sh CLI;
// the controls do not belong in collect mode and are intentionally absent here.
