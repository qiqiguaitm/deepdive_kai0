...
if __name__ == "__main__":
    ...
    parser.add_argument('--meta_out', type=str, default='dataset_meta_info', help='output root for sample jsons')
    ...
    for data_type in ['val', 'train']:
        ...
        os.makedirs(f'{args.meta_out}/{dataset_name}', exist_ok=True)
        with open(f'{args.meta_out}/{dataset_name}/{data_type}_sample.json', 'w') as f:
