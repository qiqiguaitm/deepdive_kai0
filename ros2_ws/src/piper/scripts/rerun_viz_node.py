...
class RerunVizNode(Node):
    def __init__(self):
        ...
        # Foreground mesh (Step 1–4 of docs/deployment/visualization/inference_visualization_mesh.md).
    ...
    def _tick_fg_mesh(self):
        ...
        See docs/deployment/visualization/inference_visualization_mesh.md §6. Head camera is bbox
