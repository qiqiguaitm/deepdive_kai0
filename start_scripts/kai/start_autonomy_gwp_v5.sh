...
WS_PORT="${KAI0_GWP_WS_PORT:-8005}"      # 8000 常被占; 8001=FLASH 8002=V1, gwp 用 8003
OPT_TIER="exact"; STEPS_ACT=0; STEPS_INF=10   # gwp_ans: fp8/T_a3/T_O10; gwp_ori: exact/steps_inf=5/steps_act=5(NFE5)
...
GWP_REPO="${GWP_REPO:-/data1/tim/workspace/deepdive_kai0/giga_world_policy}"
...
case "$MODEL" in
  ...
  v5)  TRANSFORMER="$GWP_REPO/runs/gwp_abs_v5/models/checkpoint_epoch_3_step_50000/transformer" ;;
  *)   echo "ERROR: --model must be ans|ori|v5"; exit 2 ;;
esac
MODEL_ID="$GWP_REPO/checkpoints/Wan2.2-TI2V-5B-Diffusers"
STATS="$GWP_REPO/assets_visrobot01_v3/norm_stats_vis_abs.json"
