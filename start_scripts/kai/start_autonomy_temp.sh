...
#
#   ./start_scripts/kai/start_autonomy_from_ckpt.sh <ckpt_dir> [extra_ros_args...]
#
# 该 launcher 自己读 sidecar + 注入 OPENPI_EXTRA_CONFIG, 不再编辑 config.py.
# Sidecar 由 train_scripts/kai/data/pack_inference_ckpt.py 在打包推理 bundle 时
...
echo "  ./start_scripts/kai/start_autonomy_from_ckpt.sh <ckpt_dir>" >&2
exit 1
