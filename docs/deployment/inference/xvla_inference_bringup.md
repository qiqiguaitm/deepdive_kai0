...
| # | 阻塞 | 状态 | 谁来做 |
|---|---|---|---|
| **A** | 可部署 ckpt 不存在 | ✅ **X3.C 拉到 (2026-05-31)**: `ckpt_others/xvla_x3c_a0423_step_final` (vis-only baseline, step30000, domain20, fixed 管线; sidecar 齐全)。X3.B/X3.A 待拉 | X3.C 已可测 |
...
### 2.1 ❌ 旧 x3a/b/c_stage_a (`ckpt_others/xvla_x3{a,b,c}_*`) — **全部作废, 禁止部署**
...
| 新 ckpt `ckpt_others/xvla_{A_0423_0527,x3b_a0423,x3a_a0423}` | 待拉取 | 部署目标 |
