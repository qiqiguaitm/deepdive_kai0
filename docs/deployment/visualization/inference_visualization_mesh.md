...
> 前置文档: `docs/deployment/visualization/inference_visualization.md`（rerun 基础集成）
...
- 本方案不改动 `docs/deployment/visualization/inference_visualization.md` 描述的 rerun 基础集成（交互执行控制、
