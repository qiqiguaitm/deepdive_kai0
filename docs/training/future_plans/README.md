...
| 优先级 | 计划 | 状态 | 资源 | ETA | 目的 |
|---|---|---|---|---|---|
| ⭐⭐⭐ P0 | [**v4 数据可用性验证 (AE AWBC)**](plans/pi05_v4_awbc_validation_plan.md) | 📝 待确认 | 8× GPU | — | 全 v4 base(1207ep)+dagger(789ep) 跑 KAI0 AE AWBC, 验证 v4 新框架(前裁+尾裁+夹爪取主臂 action≠state)可用性, 重点真机夹持稳定性 vs 旧 AWBC |
