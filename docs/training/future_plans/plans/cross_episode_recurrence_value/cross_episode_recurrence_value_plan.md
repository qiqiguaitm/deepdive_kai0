...
> **上游**:AWBC pipeline([awbc_implementation_plan.md](../../../../deployment/strategy/awbc_implementation_plan.md))。图像目录 `docs/visualization/cross_episode_recurrence_value/`(图 1-55,GitHub 直接渲染)。
...
**示例视频(git 内)**:[milestone_ep_s800_660_final_v4gated_sync.mp4](../../../../visualization/cross_episode_recurrence_value/milestone_ep_s800_660_final_v4gated_sync.mp4)(终版配方 + 门控,held-out ep660)。
...
**图像**(图1-55):`docs/visualization/cross_episode_recurrence_value/`(40+ 张,命名 `<阶段>_<数据集>_<内容>`)。
