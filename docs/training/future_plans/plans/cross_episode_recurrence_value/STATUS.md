...
- [x] **A1-切分** ✅ 20-milestone 骨架,19.3/20 到达,覆盖 0.967,~12 段/ep;raw τ=0.43 印证有序相位需 DP → [结果](../../../visualization/cross_episode_recurrence_value/crave_a1a2_results.md)
...
- **留痕**:`temp/crave_a1a2/{summary.json, segments.json, ood_residuals.npz, dedup_fingerprint.json}` + `docs/visualization/cross_episode_recurrence_value/crave_a1_*.png, crave_a2_*.png` + 结果文档 `crave_a1a2_results.md`
- **结论**:
  | 项 | 结果 | 数字 |
  |---|---|---|
