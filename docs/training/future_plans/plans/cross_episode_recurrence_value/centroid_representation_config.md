...
> 详细实验留痕见 [center_representative_research.md](../../../../visualization/cross_episode_recurrence_value/center_representative_research.md)(平均脸 deep research → patch 解码 → 对齐 → GAN → 规模消融 A–I → 解码器倒 U → ep2302 30Hz 演示)。
