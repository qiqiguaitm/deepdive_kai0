...
> 🔴 **2026-05-31 prompt-bug 重测**: 本表初版的 26-step 曲线 (@50 末段 ~0.0646) 是**用错 prompt 评的** — `eval_val_action_mse.py --prompt` 默认 `"stand up the fallen box"` (Task E), batch eval 未覆盖 → 叠衣模型被喂叠箱指令, MAE 全程虚高 ~1.8×。下表是 **正确 prompt `"Flatten and fold the cloth."` 重测的完整 26-step 曲线** (与 §8.4.4 的 plain 50k @50=0.0350 一致)。

| step | MAE@1 | @10 | @25 | @50 |
|---:|---:|---:|---:|---:|
| 2000 | 0.0152 | 0.0269 | 0.0443 | 0.0685 |
| 4000 | 0.0133 | 0.0236 | 0.0388 | 0.0592 |
| 6000 | 0.0130 | 0.0227 | 0.0370 | 0.0549 |
| 8000 | 0.0123 | 0.0214 | 0.0340 | 0.0496 |
| 10000 | 0.0118 | 0.0206 | 0.0325 | 0.0466 |
| 12000 | 0.0114 | 0.0199 | 0.0309 | 0.0440 |
| 14000 | 0.0112 | 0.0194 | 0.0298 | 0.0421 |
| 16000 | 0.0109 | 0.0188 | 0.0288 | 0.0404 |
| 18000 | 0.0111 | 0.0190 | 0.0286 | 0.0394 |
| 20000 | 0.0105 | 0.0183 | 0.0278 | 0.0385 |
| 22000 | 0.0107 | 0.0184 | 0.0278 | 0.0381 |
| 24000 | 0.0111 | 0.0184 | 0.0275 | 0.0375 |
| 26000 | 0.0107 | 0.0182 | 0.0272 | 0.0368 |
| 28000 | 0.0105 | 0.0179 | 0.0264 | 0.0358 |
| 30000 | 0.0105 | 0.0178 | 0.0265 | 0.0363 |
| 32000 | 0.0103 | 0.0179 | 0.0266 | 0.0361 |
| 34000 | 0.0104 | 0.0178 | 0.0262 | 0.0353 |
| 36000 | 0.0104 | 0.0177 | 0.0260 | 0.0352 |
| 38000 | 0.0103 | 0.0175 | 0.0259 | 0.0350 |
| 40000 | 0.0102 | 0.0177 | 0.0263 | 0.0353 |
| 42000 | 0.0102 | 0.0175 | 0.0259 | **0.0348** |
| 44000 | 0.0102 | 0.0176 | 0.0258 | 0.0348 |
| 46000 | 0.0101 | 0.0175 | 0.0258 | 0.0349 |
| 48000 | 0.0101 | 0.0175 | 0.0259 | 0.0348 |
| 49999 | 0.0101 | 0.0174 | 0.0258 | 0.0349 |
| **50000** | **0.0101** | **0.0174** | **0.0258** | **0.0349** |

**Best = step 50000, MAE@1 = 0.0101** (46k–50000 @1 并列 0.0101; @50 最低在 42k/44k/48k 的 0.0348; ~38k 后 plateau, 单调收敛无反弹)。最佳 ckpt: `kai0/checkpoints/pi05_pytorch_a_new_pure_200/A_mirror200_pi05_pytorch/50000/`。
> ⚠️ 注: 早期 step (2k–8k) 错 prompt 虚高更明显 (旧 8k @50=0.0703 vs 正确 0.0496), 因早期模型对语言指令更敏感。
