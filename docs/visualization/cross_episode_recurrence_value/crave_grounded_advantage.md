...
3. **接入路径**:在 `build_ds_A_from_mv` 产 advantage 那步,用 grounded-clean value 替代 raw value 再算 Δ/离散化 →更干净的三档标签喂 `pi05_awbc_mv_A_3lvl`(见 [AB_plan §5b/§10](../../training/future_plans/plans/cross_episode_recurrence_value/awbc_milestone_value_AB_plan.md))。
