...
> 对应 [STATUS](../../training/future_plans/plans/cross_episode_recurrence_value/STATUS.md) 的 P1 项 / [positioning](../../training/future_plans/plans/cross_episode_recurrence_value/CRAVE_positioning_and_roadmap.md) §2 A 组。
...
- **边界(诚实)**:milestone 同进度位常并发跨越(20 milestone → 实际约 **12 个去重段/ep**);raw 标签 τ=0.43 印证 [B1](../../training/future_plans/plans/cross_episode_recurrence_value/CRAVE_positioning_and_roadmap.md#b-组--核心研究补最大软肋无-action无结果信号) 的"milestone=有序技能相位但需 DP 去噪",非尖锐动作切点。
...
- 这与 [B2 否决](../../training/future_plans/plans/cross_episode_recurrence_value/CRAVE_positioning_and_roadmap.md#b-组--核心研究补最大软肋无-action无结果信号)**完全一致**:CRAVE 残差抓**粗 OOD/脱轨**,抓不到**像 demo 的细微失败**。再次独立印证 CRAVE 的失败信号只在"粗"这一档。
