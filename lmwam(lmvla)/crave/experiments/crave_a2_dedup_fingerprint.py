...
Run: /home/tim/miniconda3/envs/srpo/bin/python crave/experiments/crave_a2_dedup_fingerprint.py
"""
import json
import numpy as np

from crave.config import out_dir, viz_dir
from crave.render import setup_mpl

plt = setup_mpl()

OUT = out_dir("crave_a1a2")
SEG = OUT / "segments.json"
FIG = viz_dir()
