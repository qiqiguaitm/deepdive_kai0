...
> **上游**: [awbc_implementation_plan.md](../../docs/deployment/strategy/awbc_implementation_plan.md)(4-step 总纲)· 复用 [awbc_viva_value_comparison_plan.md](../../docs/training/future_plans/plans/awbc_viva_value_comparison_plan.md) 的"换 value 源"接口与单变量对照结构。
...
- AWBC 总纲 → [awbc_implementation_plan.md](../../docs/deployment/strategy/awbc_implementation_plan.md)
- 复用接口/结构 → [awbc_viva_value_comparison_plan.md](../../docs/training/future_plans/plans/awbc_viva_value_comparison_plan.md)
