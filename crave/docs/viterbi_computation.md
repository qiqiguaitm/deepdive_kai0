...
> 配图脚本:`train_scripts/kai/data/viterbi_compare.py`(kai0_base,kai-only);数据 `temp/crave_a1a2/viterbi_crop_summary.json`。
...
**复现**:
- §0–5 四图:`kai0/.venv/bin/python train_scripts/kai/data/viterbi_compare.py --mine-n 200 --ncrop 6` → `temp/crave_a1a2/viterbi_crop_summary.json`。
- §6 两图(回退可观测 / 循环 milestone):`kai0/.venv/bin/python train_scripts/kai/data/viterbi_observability.py --mine-n 200` → `temp/crave_a1a2/viterbi_observability.json`。
