...
if __name__ == "__main__":
    ...
    # Example: python merge_lerobot.py --src_list ./merge_list.txt --tgt_path /path/to/merged --fps 30 --robot_type agilex --repo_id my_repo --features_json ./features.json --force
