...
#ifndef ARM_CONTROL__MSG__DETAIL__JOINT_CONTROL__FUNCTIONS_H_
#define ARM_CONTROL__MSG__DETAIL__JOINT_CONTROL__FUNCTIONS_H_
 ...
 * calls
 * arm_control__msg__JointControl__init().
...
/**
 * It calls
 * arm_control__msg__JointControl__fini()
 ...
 * arm_control__msg__JointControl__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * arm_control__msg__JointControl__Sequence__fini()
 * on the array,
...
#endif  // ARM_CONTROL__MSG__DETAIL__JOINT_CONTROL__FUNCTIONS_H_
