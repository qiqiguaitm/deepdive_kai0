...
NUM_FRAMES = int(os.environ.get("TAU0_NF", "9"))   # tau0 native contiguous chunk; 9->T_lat=3, 17->5, 33->9
OFFS = list(range(NUM_FRAMES))   # CONTIGUOUS frames (tau0 pretrained on contiguous clips)
...
def main():
    ...
    out_dir = f"{root}/vae_latent_c{NUM_FRAMES}"; os.makedirs(out_dir, exist_ok=True)
