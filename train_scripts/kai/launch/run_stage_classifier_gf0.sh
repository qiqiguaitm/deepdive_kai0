...
precompute_parallel() {
    ...
    for i in 0 1 2 3 4 5 6 7; do
        ...
        ssh -p $SSH_PORT root@$GF0_IP "
            ...
            CUDA_VISIBLE_DEVICES=$i nohup $PYTHON $DEEPDIVE/train_scripts/kai/stage_classifier/precompute_features.py \
...
train_classifier() {
    ...
    ssh -p $SSH_PORT root@$GF0_IP "
        CUDA_VISIBLE_DEVICES=0 nohup $PYTHON $DEEPDIVE/train_scripts/kai/stage_classifier/train.py \
