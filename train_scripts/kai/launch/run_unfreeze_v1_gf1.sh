#!/bin/bash
# Task_E vision-unfreeze full-param fine-tune on gf1 (8×A100 80GB)
# Config: pi05_stand_box_kai0_unfreeze_15k
# batch=128, fsdp=8, LR=1.25e-5, EMA=0.9999, steps=15000
set -euo pipefail
...
.venv/bin/python scripts/train.py pi05_stand_box_kai0_unfreeze_2k \
  --exp_name=unfreeze_2k_v1 \
  --overwrite 2>&1
echo "[train] === END $(date) ==="
