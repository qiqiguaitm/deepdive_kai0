...
BUILD_PY="${BUILD_PY:-$REPO_ROOT/train_scripts/kai/data/build_task_a_mixed.py}"
GEN_STATS="${GEN_STATS:-$REPO_ROOT/train_scripts/kai/data/generate_episodes_stats.py}"
