#!/usr/bin/env python3
"""Build A_pure_1200 = ALL clean visrobot01/KAI0/Task_A/base + mirror to fill 1200 eps.
...
VIS_BASE = Path("/vePFS/visrobot01/KAI0/Task_A/base")  # directly from visrobot01 (all 8 date subdirs incl 04-30)
DST_DEFAULT = ROOT / "self_built" / "A_pure_1200"
