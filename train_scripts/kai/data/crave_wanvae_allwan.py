...
WAN = "checkpoints/Wan2.2-TI2V-5B-Diffusers"; dev = "cuda"
...
def main():
    ...
    for b in range(0, len(vi), 16):
        ...
        for k_, i in enumerate(bb): Z[i] = z[k_, :, 0].cpu().numpy()
    ...
    for c in selshow:
        ...
        rows["avg"].append(wan_dec(zc)); rows["med"].append(wan_dec(Z[md]))
