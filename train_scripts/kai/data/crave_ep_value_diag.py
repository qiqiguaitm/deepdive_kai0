...
from crave_decoder_scale_ablation import REPO, grab_ep
...
def main():
    ...
    def cam(e):
        cs = __import__("json").load(open(REPO / "kai0/data/Task_A/kai0_base/meta/info.json"))["chunks_size"]
        return f"kai0/data/Task_A/kai0_base/videos/chunk-{e//cs:03d}/observation.images.top_head/episode_{e:06d}.mp4"
