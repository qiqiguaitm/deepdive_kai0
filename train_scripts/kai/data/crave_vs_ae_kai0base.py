...
输出: docs/visualization/cross_episode_recurrence_value/crave_vs_ae_kai0base.png + 数组 npz
"""
import json, os, sys
...
aa, rr, st, n = loadep(FC, TEST); v3, lab, marg = value(aa, rr, st, ret_lab=True)
...
out = REPO / "docs/visualization/cross_episode_recurrence_value/crave_vs_ae_kai0base.png"
