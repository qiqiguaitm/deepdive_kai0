...
Run: kai0/.venv/bin/python train_scripts/kai/data/crave_aligned_centroid.py [--mine-n 200] [--members 40]
输出: docs/visualization/cross_episode_recurrence_value/crave_aligned_centroid.png + temp/crave_a1a2/aligned_centroid_metrics.json
"""
...
cs = json.load(open(DS / "meta/info.json"))["chunks_size"]; RES = 128
