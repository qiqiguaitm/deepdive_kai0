...
Run: kai0/.venv/bin/python train_scripts/kai/data/crave_cluster_gallery.py [--k 10] [--n-excellent 5] [--mine-n 250] [--test-n 150]
输出: docs/visualization/cross_episode_recurrence_value/crave_gallery_{full,excellent,quality,value_ablation}.png
