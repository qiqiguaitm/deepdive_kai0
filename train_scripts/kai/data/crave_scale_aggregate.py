...
Run: kai0/.venv/bin/python train_scripts/kai/data/crave_scale_aggregate.py [--keys A,B,C,D,E,F]
"""
...
from crave_decoder_scale_ablation import Dec  # 用于精确数解码器参数量
...
def dec_params(din, dec):
    return sum(p.numel() for p in Dec(din, dec).parameters())
