...
After building, run (not part of this script):
    python train_scripts/kai/data/generate_episodes_stats.py <dst>/base
...
def main():
    ...
    print(f"   val:   {len(val_picks)} eps / {val_frames} frames")
    print(f"\nNext:")
    print(f"   python train_scripts/kai/data/generate_episodes_stats.py {dst}/base")
    if N_val > 0:
        print(f"   python train_scripts/kai/data/generate_episodes_stats.py {dst}/val")
