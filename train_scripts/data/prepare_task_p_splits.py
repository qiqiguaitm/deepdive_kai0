...
Usage:
    python train_scripts/data/prepare_task_p_splits.py              # do it
    python train_scripts/data/prepare_task_p_splits.py --dry-run    # plan only
    python train_scripts/data/prepare_task_p_splits.py --force      # overwrite target
"""
